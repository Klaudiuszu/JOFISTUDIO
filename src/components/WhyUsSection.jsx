...
const WhyUsSection = () => {
  ...
  return (
    <section className="flex justify-center align-center lg:h-lvh lg:py-16 max-w-screen-2xl relative" id="offer">
      ...
      >
        <div className="flex flex-col lg:grid gap-8 lg:grid-cols-2 items-center py-8 px-6 lg:gap-16 lg:px-16 offer-me-section-wrapper">
          <div className="justify-center text-3xl md:text-5xl items-center lg:items-start text-center gap-4 mt-4  lg:text-left flex flex-col h-full">
            <h2 style={{letterSpacing: '-2px'}} className="font-bold why-us-header mb-4 xl:leading-[87px]">{intl.formatMessage({ id: "whyUs.header" })}</h2>
