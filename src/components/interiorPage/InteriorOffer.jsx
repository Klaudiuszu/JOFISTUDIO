...
>
  ...
  >
    <div className="flex flex-col lg:grid lg:grid-cols-2 items-center mx-auto lg:pb-[200px] pb-[50px] lg:gap-20 px-6">
      {/* Left Column */}
      <div className="flex flex-col items-start text-[#171717] lg:pl-16">
        <h5 className="font-PPHatton-medium h-[80px] text-4xl xl:text-[39px] mb-4 max-w-full">
          {tString('interiorOffer.header1')}
        </h5>
        <div className="text-center lg:text-left flex flex-col gap-4 lg:gap-6">
          <ul className="flex flex-col gap-4 text-left max-w-full text-[22px]">
          ...
          <h4 className="mundial-Light-font text-[24px] max-w-full lg:w-auto py-16 xl:py-0">
