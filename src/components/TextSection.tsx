...
const TextSection = () => {
  ...
  return (
    <section className="lg:py-[240px] py-[64px] max-w-screen-2xl mx-auto flex flex-col" id="about">
      ...
      >
        <div className="flex flex-col	 lg:grid gap-8 lg:grid-cols-2 items-center pb-8 px-6 lg:gap-16 lg:px-16 3xl:px-0">
          <div className="items-center about-me-section-wrapper text-[#171717]">
            <div className="justify-center md:text-5xl text-4xl items-center lg:items-start text-center gap-4 mt-4 lg:text-left flex flex-col h-full">
              <h2 style={{letterSpacing: '-2px'}} className="max-w-5x xl:w-[1000px] font-thin	leading-tight xl:leading-[87px] md:w-[700px] md:text-custom-85 mb-4">
      ...
      <motion.div
        ...
        className="flex justify-center"
      >
        <div className="flex flex-col	lg:mr-[62px] lg:grid gap-8 lg:grid-cols-1 items-center py-8 px-6 lg:gap-16 3xl:px-0 lg:pb-16 lg:pt-0">
