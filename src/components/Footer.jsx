...
const Footer = () => {
    ...
    return (
        <footer id="footer" ref={refSize} className="about-me-section max-w-screen-2xl 3xl:w-[1440px] mx-auto flex flex-col">
            <div className="bg" style={{ height: `${height}px` }}></div>
            <div className="px-6 py-[82px] xl:py-[200px] 2xl:px-0 flex flex-col lg:gap-[80px] items-center w-full">
                    ...
                    <div className="md:flex md:justify-between w-full">
                        <div className="grid grid-cols-2 w-full gap-8 2xl:gap-[80px] sm:gap-6 sm:grid-cols-4 text-[#000]">
                            ...
                            <div className="flex xl:justify-start flex-col sm:hidden">
                                <h2 className="mb-4 text-[20px] mundial-Light-font uppercase font-semibold">
                                </h2>
                            ...
                            <div className="flex xl:justify-start flex-col">
                                ...
                                <ul className=" font-thin">
                                    <li className="mb-4">
                                        ...
                                        <a className=" fle gap-2 items-center text-[14px] md:text-[20px] mundial-Light-font">{tString("footer.col2NumberMikolaj")}</a>
                                    </li>
                                </ul>
                            </div>
                            <div className="flex justify-start flex-col">
                            ...
                            <div>
                                <h2 className="mb-6 text-[20px] mundial-Light-font uppercase font-semibold">
